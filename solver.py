...
class grad_anneal(nn.Module):
    ...
    def forward(self, outputs, inputs, cur_iter):
        ...
        G_RV = torch.randn((self.batch_size, self.feature_size), requires_grad=True).to(self.device)
...
class ZeroShotKTSolver(object):
    ...
    def __init__(self, args):
        ...
        self.optimizer_generator = optim.AdamW(self.generator.parameters(), lr=args.generator_learning_rate, weight_decay=1e-2)
        ...
        self.optimizer_student = optim.AdamW(self.student.parameters(), lr=args.student_learning_rate, weight_decay=1e-2)
